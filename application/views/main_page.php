      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <li class="nav-item">
            <?php  if (User_model::is_logged()) {?>
              ...
              <button type="button" class="btn btn-success my-2 my-sm-0" type="submit" data-toggle="modal"
                      data-target="#amountModal">Purchase likes
              </button>
            <?php }?>
        </li>
      </div>
        ...
        <div class="modal-body">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <div v-for="comment in post.comments" :style="{ marginLeft: getPadding(comment) + 'px'}">
                <div class="form-inline">
                  <p class="card-text">
                    <small class="text-muted">{{comment.time_created + ' / '}}</small>
                    <strong>{{comment.user.personaname + ' - '}}</strong>
                    <a href="#" @click="setAssignComment(comment.id)" class="btn-light">Ответить</a>
                  </p>
